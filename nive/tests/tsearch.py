...
class SearchTest_db(unittest.TestCase):
    ...
    def test_search(self):
        ...
        self.assert_(r.SearchFulltext({"searchPhrase": "text"}, fields = fields1, sort = "title", ascending = 1, start = 0, max = 300)["count"])
        self.assert_(r.SearchFulltextType(pool_type, {"searchPhrase": "text"}, fields = fields2, sort = "title", ascending = 1, start = 0, max = 300)["count"])
